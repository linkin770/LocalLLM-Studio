...
import { escapeHtml, visibleLogs, statusLabel, statusClass, detectLogLevel } from '../utils'
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            background: generating ? "var(--muted)" : undefined,
        ...
        >
          ...
          <div className="error-callout">{genError}</div>
        )}
                ...
                {!skillsLoaded ? (
                  ...
                  <div className="settings-stack">
                    {skillsList.map((skill) => (
                      <div key={skill.dirName} className="settings-card skill-card">
          ...
          <div className="log-box" id="logBox">
            {visibleLogs(logs).length > 0 ? (
              visibleLogs(logs).map((entry, index) => (
                <div key={index} className="log-entry" data-level={detectLogLevel(entry)}>
